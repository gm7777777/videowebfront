<template>
    ...
    <div style="border-left: 1px solid #ccc;border-top: 1px solid #ccc;border-bottom: 1px solid #ccc;width:50%">
        <el-descriptions title="图书上传" style="margin:10px;font-size:larger;" :column="1">
    ...
    <el-row>
        ...
        <el-button type="primary" :icon="Edit" style="float:left;margin-left:20px;margin-bottom: 5px;" @click="submitDocs">提交</el-button>
    </el-row>
...
<script>
    ...
    import {addDoc} from "../apis/readerdoc";
    export default {
        name: "DocReaderEditor",
